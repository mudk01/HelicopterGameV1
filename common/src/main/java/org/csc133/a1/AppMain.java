...
class GameWorld {
    ...
    private void init() {
        ...
        fireLocatonRight = new Point(new Random().nextInt(50) +
                ...
                Game.DISP_H/3 -
                (int)(Game.DISP_H/3.5));
        fireLeft = new Fire(fireSizeLeft, fireLocationLeft);
        fireCenter = new Fire(fireSizeRight, fireLocationCenter);
        fireRight = new Fire(fireSizeCenter, fireLocatonRight);
        fires = new ArrayList<>();
...
class River {
    ...
    void draw(Graphics g) {
        ...
        g.drawRect(location.getX(),location.getY(), width, height, 5);
    }
}
